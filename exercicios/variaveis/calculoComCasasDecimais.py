'''
    ...
    A precisão de casas decimais nos cálculos monetários com mais de duas caasas decimais.
    ...
    divisão por 1.000.000, assim se obtem o resultado com precisão de casas de cimais.
'''
